...
- compiler-sfc prettify functionality removed
- Internet Explorer support has been removed
- vue-template-compiler deindent option has been removed
- PUG template language removed
- LESS language removed
- Stylus language removed
